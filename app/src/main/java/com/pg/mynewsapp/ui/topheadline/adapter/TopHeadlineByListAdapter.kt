package com.pg.mynewsapp.ui.topheadline.adapter
...
import com.pg.mynewsapp.databinding.TopHeadlineItemRowLayoutBinding

class TopHeadlineByListAdapter(
    private val articleList: ArrayList<Any>
) : RecyclerView.Adapter<TopHeadlineByListAdapter.DataViewHolder>() {

    lateinit var itemClickListener: ItemClickListener<Any>

    class DataViewHolder(private val binding: TopHeadlineItemRowLayoutBinding) :
        ...
        fun bindDBItem(article: Article, itemClickListener: ItemClickListener<Any>) {
            binding.textViewTitle.text = article.title
            binding.textViewDescription.text = article.description
            binding.textViewSource.text = "News By - " + article.source.name
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = DataViewHolder(
        TopHeadlineItemRowLayoutBinding.inflate(
